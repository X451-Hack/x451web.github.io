<?php 
$judul =" Privacy Policy Generator Bahasa Indonesia ";
include 'head.php';
?>
<center> <h2> PRIVACY POLICY GENERATOR BAHASA INDONESIA</h2>

<form name="myForm" id="myForm" onsubmit="return validateForm('myForm');" method="get">


<input type="text" pattern="https?://.+" name="situs" class="form-control" widht="50" placeholder="URL Situs Mu" />

<input class="form-control" type="text" name="nama" placeholder="Nama Situs Mu" />
...
<input class="btn btn-warning" type="submit" value="Mulai" name="submit" />
